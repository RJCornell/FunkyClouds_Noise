...
// Try 1 for a slow moving effect, 60 for something that is looking like water.
// uint16_t speed = 1; // almost looks like a painting, moves very slowly

   uint16_t speed = 80; // a nice starting speed, mixes well with a scale of 100
// uint16_t speed = 33;
// uint16_t speed = 100; // wicked fast!

// Scale determines how far apart the pixels in our noise matrix are.  
// Try changing these values around & see how it affects the motion of display. 
// The higher the value of scale, the more "zoomed out" the noise iwll be.  
