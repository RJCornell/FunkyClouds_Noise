...
#define kMatrixWidth  30 // was 16
#define kMatrixHeight 8 // was 16
...
void setup() {
  ...
  random16_set_seed(9934);// 8934
  random16_add_entropy(analogRead(1));// was 3

  Serial.begin(115200);// was (57600);
  Serial.println(" resetting!");

  delay(1000);
  LEDS.addLeds<WS2812, 6, BGR>(leds,NUM_LEDS);
  LEDS.setBrightness(170);// was 96
// ---------------------------------------------------------------------------
